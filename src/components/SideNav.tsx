...
export const SideNav = ({ roms, setSelectedConsole, selectedConsole }) => {
  return (
    <>
      <button
        data-drawer-target="console-nav"
        data-drawer-toggle="console-nav"
            ...
            {getNavItems(roms).map(({ console }) => (
              <li>
                <button
                  ...
                  className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 text-left"
                >
                  {/* <svg
                  aria-hidden="true"
